...
const Hero = () => (
    ...
    >
        <div
            className={`flex-1 ${styles.flexStart} flex-col relative xl:px-0 sm:pr-16 pr-6`}
        >
            ...
            <div className="flex flex-row justify-between items-center w-full">
                <h1 className="flex-1 font-poppins font-semibold ss:text-[68px] text-[48px] text-white ss:leading-[100px] leading-[75px]">
            ...
            <div className="absolute z-0 w-[50%] h-[50%] top-[40px] left-[-200px] white__gradient-2"></div>
        </div>
